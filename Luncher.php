<?php
define('BOT_TOKEN', '251280859:AAG4V3gqXgt8sY1pWrWYJdtdclr_xJp9N-E');
...
لطفا پیام ندهید🖕" ,"parse_mode" =>"HTML"));	
	...
	apiRequest("sendMessage", array('chat_id' => $chat_id, "text" => "🗣پیامت سیش رفت عزیزم" ,"parse_mode" =>"HTML"));
...
define('WEBHOOK_URL', 'https://seyyedpvresanbot-seyyedpvresanbot.rhcloud.com');
